...
Project created from [data science project template][template]
at [{% if cookiecutter.template_version is eq "auto" %}`{% gitcommit short=True %}`{% else %}{{ cookiecutter.template_version }}{% endif %}][template-base]
on {{ cookiecutter.created_date }}.

[template]: {{ cookiecutter.template_url }}
[template-base]: {{ cookiecutter.template_url }}/?at={% gitcommit %}

[black]: https://black.readthedocs.io/en/stable/index.html
[docker]: https://www.docker.com/
[docker4windows]: https://docs.docker.com/docker-for-windows/
